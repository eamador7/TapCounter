...
This directory is intended for raw sound effect files.

To enable sound effects in the app, please add the following two files to this directory:

1.  `tick_up.mp3` (played when the counter is incremented)
